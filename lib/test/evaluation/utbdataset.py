...
class UTBSVDataset(BaseDataset):
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.utb_path
        self.sequence_info_list = self._get_sequence_info_list()
...
class UTBOVDataset(BaseDataset):
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.utb_path
        self.sequence_info_list = self._get_sequence_info_list()
...
class UTBPFODataset(BaseDataset):
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.utb_path
        self.sequence_info_list = self._get_sequence_info_list()
...
class UTBDADataset(BaseDataset):
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.utb_path
        self.sequence_info_list = self._get_sequence_info_list()
...
class UTBLRDataset(BaseDataset):
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.utb_path
        self.sequence_info_list = self._get_sequence_info_list()
...
class UTBFMDataset(BaseDataset):
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.utb_path
        self.sequence_info_list = self._get_sequence_info_list()
...
class UTBMBDataset(BaseDataset):
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.utb_path
        self.sequence_info_list = self._get_sequence_info_list()
