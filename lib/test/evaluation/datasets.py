...
dataset_dict = dict(
    ...
    utb_sv=DatasetInfo(module=pt % 'utb', class_name='UTBSVDataset', kwargs=dict()),
    utb_ov=DatasetInfo(module=pt % 'utb', class_name='UTBOVDataset', kwargs=dict()),
    utb_pfo=DatasetInfo(module=pt % 'utb', class_name='UTBPFODataset', kwargs=dict()),
    utb_da=DatasetInfo(module=pt % 'utb', class_name='UTBDADataset', kwargs=dict()),
    utb_lr = DatasetInfo(module=pt % 'utb', class_name='UTBLRDataset', kwargs=dict()),
    utb_fm=DatasetInfo(module=pt % 'utb', class_name='UTBFMDataset', kwargs=dict()),
    utb_mb=DatasetInfo(module=pt % 'utb', class_name='UTBMBDataset', kwargs=dict()),
)
